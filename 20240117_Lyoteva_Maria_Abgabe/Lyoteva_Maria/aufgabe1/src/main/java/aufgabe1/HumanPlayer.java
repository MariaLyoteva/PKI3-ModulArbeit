...
/**
 * The {@code HumanPlayer} class describes the behavior of a human player and is an implementation
...
public class HumanPlayer implements IPlayer {
	 ...
	 * attempts making a move, it will throw an {@link InvalidMoveException} .
	 * 
